...
def main():
    ...
    lines.append("exact 1128 rows are a SUBSET of the 2928 examples the shipped model's parameters")
    ...
    lines.append("For the model's accuracy on truly UNSEEN phrasing, see the template-level")
    lines.append("held-out split in app/build/ml-model-accuracy-report.txt (82.83%), which is the")
    lines.append("more honest estimate of real-world performance on new notifications.")
    lines.append("")
